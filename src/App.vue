      ...
      <div class="header__wrapper container">
        ...
        <div v-if="isLoading">
          <router-link class="header__cart" aria-label="Корзина с товарами" :to="{name: 'cart'}">
            ...
            <span class="header__count" aria-label="Количество товаров"><img src="/img/1496.gif" style="margin: 0 auto; display: block;" width="10" alt="loading"></span>
          </router-link>
        </div>

        <CartIndicator v-if="!isLoading"/>
