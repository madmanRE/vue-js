        ...
        <div class="item__info">
          ...
          <div class="item__form">
            <form class="form" action="#" method="POST" @submit.prevent="addToCart">
              ...
              <div class="item__row">
                <button-change-amount-of-product :productAmount.sync="initialProductAmount" />
...
import ButtonChangeAmountOfProduct from "@/components/ButtonChangeAmountOfProduct.vue";
    ...
    methods: {
      ...
      addToCart() {
        ...
        this.addProductToCart(
            {productId: this.product.id, amount: this.initialProductAmount}
        )
            .then(() => {
